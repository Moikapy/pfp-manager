...
async function metadataSettings() {
  ...
  name = "Wolf";
  description =
    "A specially curated collection of 5,555 Wolf NFTs. The Wolf Pack implements a lifetime royalty for all minters and a reflection tax to all current holders.";
...
async function setNames(trait) {
  ...
  //   file = file.charAt(0).toUpperCase() + file.slice(1).toLowerCase()
  //   namePrompt.push({
  //     type: 'input',
  //     name: trait + '_name_' + i,
